...
namespace VSL
{
    ...
    public class ThreadMgr : IDisposable
    {
        ...
        public void Invoke(Action<CancellationToken> work)
        {
            ...
            if (Mode == InvokeMode.Dispatcher)
                dispatcher.InvokeOnMainThread(() => work(ct));
            else
            {
        ...
        public Task InvokeAsync(Action<CancellationToken> work)
        {
            ...
            return Task.Run(() => dispatcher.InvokeOnMainThread(() => work.Invoke(itemCt)));
        }
        /// <summary>
        ...
        /// <summary>
        /// Sets the specified <see cref="NSObject"/> (as example a View) as thread to invoke events on. This method is only available with <see cref="InvokeMode.Dispatcher"/>.
        /// </summary>
        /// <param name="invokeThread">Thread to invoke events on.</param>
        public void SetInvokeThread(NSObject invokeThread)
        {
